defmodule AnythingWeb.CoreComponents do
  @moduledoc """
  ...
  def header(assigns) do
    ...
    <section class="hero">
      <div class="hero-body">
        ...
        <div class="field is-grouped"><%= render_slot(@actions) %></div>
      </div>
    </section>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnythingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnythingWeb.Gettext, "errors", msg, opts)
    end
  end
